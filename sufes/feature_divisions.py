"""Divisions feature (A0 diagnostic across primes).
...
def residu_divisions(
    ...
    base_name = f"divisions_n{n_val}_p{pmax}_i{i_val}{j_part}{jmult_part}"
    ...
    try:
        ...
        out_mean_csv = os.path.join(run_dir, f"divisions_meanA0_{base_name}.csv")
    ...
    try:
        ...
        if ks:
            ...
            fig.tight_layout()
            out_png = os.path.join(run_dir, f"divisions_meanA0_{base_name}.png")
            try:
    ...
    # Legacy options are intentionally ignored after the divisions cleanup.
